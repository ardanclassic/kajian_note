        ...
        <div className="relative z-10 px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              <AlertCircle className={`w-4 h-4 ${getTextColor(notesColor)} shrink-0`} />
            ...
            <Button
              size="sm"
              asChild
              className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/50 hover:bg-emerald-500/20 hover:border-emerald-500 shadow-lg shadow-emerald-500/10 shrink-0"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3 flex-1">
              <div className="w-10 h-10 bg-emerald-500/10 border border-emerald-500/50 rounded-lg flex items-center justify-center shrink-0">
            ...
            <div className="px-2.5 py-1 bg-gray-800 border border-gray-700 rounded-md text-xs font-semibold text-gray-400 shrink-0">
