...
export function Display({ children, className, as: Component = "h1" }: TypographyProps) {
  return (
    <Component className={cn(
      "font-black text-5xl md:text-6xl lg:text-7xl leading-tight tracking-tighter text-white",
      className
    )}>
      {children}
    </Component>
...
export function H1({ children, className, as: Component = "h1" }: TypographyProps) {
  return (
    <Component className={cn(
      "font-black text-4xl md:text-5xl leading-tight tracking-tight text-white",
      className
    )}>
      {children}
    </Component>
...
export function H2({ children, className, as: Component = "h2" }: TypographyProps) {
  return (
    <Component className={cn(
      "font-black text-3xl md:text-4xl leading-tight tracking-tight text-white",
      className
    )}>
      {children}
    </Component>
...
export function H3({ children, className, as: Component = "h3" }: TypographyProps) {
  return (
    <Component className={cn(
      "font-bold text-2xl md:text-3xl leading-snug text-white",
      className
    )}>
      {children}
    </Component>
...
export function H4({ children, className, as: Component = "h4" }: TypographyProps) {
  return (
    <Component className={cn(
      "font-bold text-xl md:text-2xl leading-snug text-white",
      className
    )}>
      {children}
    </Component>
...
export function BodySmall({ children, className, as: Component = "p" }: TypographyProps) {
  return (
    <Component className={cn(
      "text-sm leading-normal text-gray-400",
      className
    )}>
      {children}
    </Component>
...
export function Lead({ children, className, as: Component = "p" }: TypographyProps) {
  return (
    <Component className={cn(
      "text-xl md:text-2xl leading-relaxed text-gray-300 font-light",
      className
    )}>
      {children}
    </Component>
...
export function Blockquote({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <blockquote className={cn(
      "mt-6 border-l-4 border-emerald-500 pl-6 italic text-gray-300",
      className
    )}>
      {children}
    </blockquote>
...
export function ArabicText({ children, className, as: Component = "p" }: TypographyProps) {
  return (
    <Component className={cn(
      "font-arabic text-xl md:text-2xl leading-loose text-white text-right",
      className
    )} dir="rtl">
      {children}
    </Component>
